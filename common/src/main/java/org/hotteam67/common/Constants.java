...
public class Constants
{
     ...
     */
    public static final String MASTER_SCHEDULE_TAG = ":TEAM:,,,,";
    /**
     * Schema sent to the scouter
     */
    public static final String MASTER_SCHEMA_TAG = ":SCHEMA:,,";
    /**
     * No data, just that the master has received the last sent team from the scouter, for sync-all
     */
    public static final String SCOUTER_TEAMS_RECEIVED_TAG = ":HEARD:,,,";
    /**
